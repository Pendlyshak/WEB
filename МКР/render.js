...
class UserCollectionWithDOM extends UserCollection {
    ...
    createClickHadlers() {
        ...
        window.AddNewUser = () => {
            ...
            const gender = document.getElementsByName("price")[0].value;
            const birthYear = document.getElementsByName("manufacturer")[0].value;
        ...
        window.EditUser = () => {
            ...
            const gender = document.getElementsByName("price")[1].value;
            const birthYear = document.getElementsByName("manufacturer")[1].value;
